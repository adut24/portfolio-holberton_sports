...
{
    [SerializeField]
    private InputActionReference _triggerLeftController;
    [SerializeField]
    private InputActionReference _triggerRightController;
    [SerializeField]
    private Image _leftTrigger;
    [SerializeField]
    private Image _rightTrigger;
    [SerializeField]
    private Sprite _leftTriggerNotPressed;
    [SerializeField]
    private Sprite _rightTriggerNotPressed;
    [SerializeField]
